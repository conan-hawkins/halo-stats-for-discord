...
def build_stats_help_guide_embed(stats_profiles: Iterable[StatsProfile], is_admin: bool = False) -> discord.Embed:
    embed = discord.Embed(
    ...
    embed.add_field(
        ...
        value=(
            ...
            "`#halogroups <gamertag>`: Co-play communities and overlap matrix.\n"
    ...
    embed.add_field(
        ...
        value=(
            ...
            "`#crawlfriends <gamertag> [depth]` / `#crawlstop`: Crawl Halo-active friends and update graph DB (advanced backfill).\n"
            ...
            "`#terminal`: Opens the interactive terminal controller."
        ),
        inline=False,
    )
    ...
    embed.add_field(
        ...
        value=(
            ...
            "4) If coverage is still sparse, use backfill commands: `#crawlfriends` then `#crawlgames`."
        ),
        inline=False,
    )
